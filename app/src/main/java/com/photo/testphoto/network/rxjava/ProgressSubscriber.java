package com.photo.testphoto.network.rxjava;
...
import static com.photo.testphoto.network.rxjava.ApiException.BAD_NETWORK;
import static com.photo.testphoto.network.rxjava.ApiException.CONNECT_ERROR;
import static com.photo.testphoto.network.rxjava.ApiException.CONNECT_TIMEOUT;
import static com.photo.testphoto.network.rxjava.ApiException.PARSE_ERROR;
import static com.photo.testphoto.network.rxjava.ApiException.UNKNOWN_ERROR;
...
public class ProgressSubscriber<T extends BaseBean> implements
    ...
    public void onNext(T t) {
        ...
        if (mSubscriberOnNextListener != null) {
            ...
            else if(t.getImages()!=null){
                mSubscriberOnNextListener.onNext(t.getImages());
            }else {
                onFail(t);
            }
        } else {
